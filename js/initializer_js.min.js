...
function() {
    ...
    function(n) {
        function t(t, r, f, e, o) {
            function w() {
                ...
                o.origSort = [];
                o.checkSort = [];
                k.removeStyle(o.prefix + "filter, filter, " + o.prefix + "transform, transform, opacity, display").css(o.clean).removeAttr("data-checksum");
                window.atob || k.css({
                    display: "none",
                    opacity: "0"
                });
                l.removeStyle(o.prefix + "transition, transition, " + o.prefix + "perspective, perspective, " + o.prefix + "perspective-origin, perspective-origin, " + (o.resizeContainer ? "height" : ""));
                "list" == o.layoutMode ? (a.css({
                    display: o.targetDisplayList,
                    opacity: "1"
                }), o.origDisplay = o.targetDisplayList) : (a.css({
                    display: o.targetDisplayGrid,
                    opacity: "1"
                }), o.origDisplay = o.targetDisplayGrid);
                o.origLayout = o.layoutMode;
                setTimeout(function() {
                    if (k.removeStyle(o.prefix + "transition, transition"), o.mixing = !1, "function" == typeof o.onMixEnd) {
                        var n = o.onMixEnd.call(this, o);
                        o = n ? n : o
                    }
                })
            }
            var v, s, h, g, k, l;
            for (clearInterval(o.failsafe), o.mixing = !0, o.filter = t, "function" == typeof o.onMixStart && (s = o.onMixStart.call(this, o), o = s ? s : o), v = o.transitionSpeed, s = 0; 2 > s; s++) h = 0 == s ? h = o.prefix : "", o.transition[h + "transition"] = "all " + v + "ms linear", o.transition[h + "transform"] = h + "translate3d(0,0,0)", o.perspective[h + "perspective"] = o.perspectiveDistance + "px", o.perspective[h + "perspective-origin"] = o.perspectiveOrigin;
            g = o.targetSelector;
            k = e.find(g);
            k.each(function() {
                this.data = {}
            ...
            l = k.parent();
            l.css(o.perspective);
            o.easingFallback = "ease-in-out";
            "smooth" == o.easing && (o.easing = "cubic-bezier(0.25, 0.46, 0.45, 0.94)");
            "snap" == o.easing && (o.easing = "cubic-bezier(0.77, 0, 0.175, 1)");
            "windback" == o.easing && (o.easing = "cubic-bezier(0.175, 0.885, 0.320, 1.275)", o.easingFallback = "cubic-bezier(0.175, 0.885, 0.320, 1)");
            "windup" == o.easing && (o.easing = "cubic-bezier(0.6, -0.28, 0.735, 0.045)", o.easingFallback = "cubic-bezier(0.6, 0.28, 0.735, 0.045)");
            s = "list" == o.layoutMode && null != o.listEffects ? o.listEffects : o.effects;
            Array.prototype.indexOf && (o.fade = -1 < s.indexOf("fade") ? "0" : "", o.scale = -1 < s.indexOf("scale") ? "scale(.01)" : "", o.rotateZ = -1 < s.indexOf("rotateZ") ? "rotate(180deg)" : "", o.rotateY = -1 < s.indexOf("rotateY") ? "rotateY(90deg)" : "", o.rotateX = -1 < s.indexOf("rotateX") ? "rotateX(90deg)" : "", o.blur = -1 < s.indexOf("blur") ? "blur(8px)" : "", o.grayscale = -1 < s.indexOf("grayscale") ? "grayscale(100%)" : "");
            var a = n(),
                p = n(),
                b = [],
                nt = !1;
            "string" == typeof t ? b = u(t) : (nt = !0, n.each(t, function(n) {
                b[n] = u(this)
            }));
            "or" == o.filterLogic ? ("" == b[0] && b.shift(), 1 > b.length ? p = p.add(e.find(g + ":visible")) : k.each(function() {
                var t = n(this),
                    i;
                nt ? (i = 0, n.each(b, function() {
                    this.length ? t.is("." + this.join(", .")) && i++ : 0 < i && i++
                }), i == b.length ? a = a.add(t) : p = p.add(t)) : t.is("." + b.join(", .")) ? a = a.add(t) : p = p.add(t)
            })) : (a = a.add(l.find(g + "." + b.join("."))), p = p.add(l.find(g + ":not(." + b.join(".") + "):visible")));
            t = a.length;
            var d = n(),
                y = n(),
                c = n();
            if (p.each(function() {
                    var t = n(this);
                    "none" != t.css("display") && (d = d.add(t), c = c.add(t))
                }), a.filter(":visible").length == t && !d.length && !r) {
                if (o.origLayout == o.layoutMode) return w(), !1;
                if (1 == a.length) return "list" == o.layoutMode ? (e.addClass(o.listClass), e.removeClass(o.gridClass), c.css("display", o.targetDisplayList)) : (e.addClass(o.gridClass), e.removeClass(o.listClass), c.css("display", o.targetDisplayGrid)), w(), !1
            }
            if (o.origHeight = l.height(), a.length) {
                if (e.removeClass(o.failClass), a.each(function() {
                        var t = n(this);
                        "none" == t.css("display") ? y = y.add(t) : c = c.add(t)
                    }), o.origLayout != o.layoutMode && !1 == o.animateGridList) return "list" == o.layoutMode ? (e.addClass(o.listClass), e.removeClass(o.gridClass), c.css("display", o.targetDisplayList)) : (e.addClass(o.gridClass), e.removeClass(o.listClass), c.css("display", o.targetDisplayGrid)), w(), !1;
                if (!window.atob) return w(), !1;
                if (k.css(o.clean), c.each(function() {
                        this.data.origPos = n(this).offset()
                    }), "list" == o.layoutMode ? (e.addClass(o.listClass), e.removeClass(o.gridClass), y.css("display", o.targetDisplayList)) : (e.addClass(o.gridClass), e.removeClass(o.listClass), y.css("display", o.targetDisplayGrid)), y.each(function() {
                        this.data.showInterPos = n(this).offset()
                    }), d.each(function() {
                        this.data.hideInterPos = n(this).offset()
                    }), c.each(function() {
                        this.data.preInterPos = n(this).offset()
                    }), "list" == o.layoutMode ? c.css("display", o.targetDisplayList) : c.css("display", o.targetDisplayGrid), r && i(r, f, e, o), t = r) n: if (t = o.origSort, s = o.checkSort, t.length != s.length) t = !1;
                    else {
                        for (h = 0; h < s.length; h++)
                            if (t[h].compare && !t[h].compare(s[h]) || t[h] !== s[h]) {
                                t = !1;
                                break n
                            }
                        t = !0
                ...
                if (t) return w(), !1;
                for (d.hide(), y.each(function() {
                        this.data.finalPos = n(this).offset()
                    }), c.each(function() {
                        this.data.finalPrePos = n(this).offset()
                    }), o.newHeight = l.height(), r && i("reset", null, e, o), y.hide(), c.css("display", o.origDisplay), "block" == o.origDisplay ? (e.addClass(o.listClass), y.css("display", o.targetDisplayList)) : (e.removeClass(o.listClass), y.css("display", o.targetDisplayGrid)), o.resizeContainer && l.css("height", o.origHeight + "px"), t = {}, s = 0; 2 > s; s++) h = 0 == s ? h = o.prefix : "", t[h + "transform"] = o.scale + " " + o.rotateX + " " + o.rotateY + " " + o.rotateZ, t[h + "filter"] = o.blur + " " + o.grayscale;
                y.css(t);
                c.each(function() {
                    var t = this.data,
                        f = n(this),
                        r, i, u;
                    for (f.hasClass("mix_tohide") ? (t.preTX = t.origPos.left - t.hideInterPos.left, t.preTY = t.origPos.top - t.hideInterPos.top) : (t.preTX = t.origPos.left - t.preInterPos.left, t.preTY = t.origPos.top - t.preInterPos.top), r = {}, i = 0; 2 > i; i++) u = 0 == i ? u = o.prefix : "", r[u + "transform"] = "translate(" + t.preTX + "px," + t.preTY + "px)";
                    f.css(r)
                });
                "list" == o.layoutMode ? (e.addClass(o.listClass), e.removeClass(o.gridClass)) : (e.addClass(o.gridClass), e.removeClass(o.listClass));
                setTimeout(function() {
                    var t, r, i;
                    if (o.resizeContainer) {
                        for (t = {}, r = 0; 2 > r; r++) i = 0 == r ? i = o.prefix : "", t[i + "transition"] = "all " + v + "ms ease-in-out", t.height = o.newHeight + "px";
                        l.css(t)
                    }
                    for (d.css("opacity", o.fade), y.css("opacity", 1), y.each(function() {
                            var i = this.data,
                                r, u, t;
                            ...
                            n(this).css("-webkit-transition", "all " + v + "ms " + o.easingFallback).css(r)
                        }), c.each(function() {
                            var t = this.data,
                                i, r, u;
                            for (t.tX = 0 != t.finalPrePos.left ? t.finalPrePos.left - t.preInterPos.left : 0, t.tY = 0 != t.finalPrePos.left ? t.finalPrePos.top - t.preInterPos.top : 0, i = {}, r = 0; 2 > r; r++) u = 0 == r ? u = o.prefix : "", i[u + "transition"] = "all " + v + "ms " + o.easing, i[u + "transform"] = "translate(" + t.tX + "px," + t.tY + "px)";
                            n(this).css("-webkit-transition", "all " + v + "ms " + o.easingFallback).css(i)
                        }), t = {}, r = 0; 2 > r; r++) i = 0 == r ? i = o.prefix : "", t[i + "transition"] = "all " + v + "ms " + o.easing + ", " + i + "filter " + v + "ms linear, opacity " + v + "ms linear", t[i + "transform"] = o.scale + " " + o.rotateX + " " + o.rotateY + " " + o.rotateZ, t[i + "filter"] = o.blur + " " + o.grayscale, t.opacity = o.fade;
                    d.css(t);
                    l.bind("webkitTransitionEnd transitionend otransitionend oTransitionEnd", function(t) {
                        (-1 < t.originalEvent.propertyName.indexOf("transform") || -1 < t.originalEvent.propertyName.indexOf("opacity")) && (-1 < g.indexOf(".") ? n(t.target).hasClass(g.replace(".", "")) && w() : n(t.target).is(g) && w())
                    })
                }, 10);
                o.failsafe = setTimeout(function() {
                    o.mixing && w()
                }, v + 400)
            } else {
                if (o.resizeContainer && l.css("height", o.origHeight + "px"), !window.atob) return w(), !1;
                d = p;
                setTimeout(function() {
                    var n, t, i;
                    if (l.css(o.perspective), o.resizeContainer) {
                        for (n = {}, t = 0; 2 > t; t++) i = 0 == t ? i = o.prefix : "", n[i + "transition"] = "height " + v + "ms ease-in-out", n.height = o.minHeight + "px";
                        l.css(n)
                    }
                    if (k.css(o.transition), p.length) {
                        for (n = {}, t = 0; 2 > t; t++) i = 0 == t ? i = o.prefix : "", n[i + "transform"] = o.scale + " " + o.rotateX + " " + o.rotateY + " " + o.rotateZ, n[i + "filter"] = o.blur + " " + o.grayscale, n.opacity = o.fade;
                        d.css(n);
                        l.bind("webkitTransitionEnd transitionend otransitionend oTransitionEnd", function(n) {
                            (-1 < n.originalEvent.propertyName.indexOf("transform") || -1 < n.originalEvent.propertyName.indexOf("opacity")) && (e.addClass(o.failClass), w())
                        })
                    } else o.mixing = !1
                }, 10)
            }
        ...
        function i(t, i, r, u) {
            function a(n, i) {
                var r = isNaN(1 * n.attr(t)) ? n.attr(t).toLowerCase() : 1 * n.attr(t),
                    u = isNaN(1 * i.attr(t)) ? i.attr(t).toLowerCase() : 1 * i.attr(t);
                return r < u ? -1 : r > u ? 1 : 0
            }

            function o(n) {
                "asc" == i ? f.prepend(n).prepend(" ") : f.append(n).append(" ")
            }
            var f, h, l;
            if (r.find(u.targetSelector).wrapAll('<div class="mix_sorter"/>'), f = r.find(".mix_sorter"), u.origSort.length || f.find(u.targetSelector + ":visible").each(function() {
                    n(this).wrap("<s/>");
                    u.origSort.push(n(this).parent().html().replace(/\s+/g, ""));
                    n(this).unwrap()
                }), f.empty(), "reset" == t) n.each(u.startOrder, function() {
                f.append(this).append(" ")
            });
            else if ("default" == t) n.each(u.origOrder, function() {
                o(this)
            });
            else if ("random" == t) {
                if (!u.newOrder.length) {
                    for (var e = u.startOrder.slice(), c = e.length, s = c; s--;) h = parseInt(Math.random() * c), l = e[s], e[s] = e[h], e[h] = l;
                    u.newOrder = e
                }
                n.each(u.newOrder, function() {
                    f.append(this).append(" ")
                })
            } else if ("custom" == t) n.each(i, function() {
                o(this)
            });
            else {
                if ("undefined" == typeof u.origOrder[0].attr(t)) return console.log("No such attribute found. Terminating"), !1;
                u.newOrder.length || (n.each(u.origOrder, function() {
                    u.newOrder.push(n(this))
                }), u.newOrder.sort(a));
                n.each(u.newOrder, function() {
                    o(this)
                })
            ...
            u.checkSort = [];
            f.find(u.targetSelector + ":visible").each(function(t) {
                var i = n(this);
                0 == t && i.attr("data-checksum", "1");
                i.wrap("<s/>");
                u.checkSort.push(i.parent().html().replace(/\s+/g, ""));
                i.unwrap()
            });
            r.find(u.targetSelector).unwrap()
        }
        ...
        var r = {
            init: function(r) {
                return this.each(function() {
                    ...
                    r && n.extend(u, r);
                    this.config = u;
                    n.support.touch = "ontouchend" in document;
                    n.support.touch && (u.isTouch = !0, u.resetDelay = 350);
                    u.container = n(this);
                    o = u.container;
                    n: {
                        for (f = o[0], c = ["Webkit", "Moz", "O", "ms"], h = 0; h < c.length; h++)
                            if (c[h] + "Transition" in f.style) {
                                f = c[h];
                                break n
                            }
                        f = "transition" in f.style ? "" : !1
                    }
                    for (u.prefix = f, u.prefix = u.prefix ? "-" + u.prefix.toLowerCase() + "-" : "", o.find(u.targetSelector).each(function() {
                            u.origOrder.push(n(this))
                        }), u.sortOnLoad && (n.isArray(u.sortOnLoad) ? (f = u.sortOnLoad[0], e = u.sortOnLoad[1], n(u.sortSelector + "[data-sort=" + u.sortOnLoad[0] + "][data-order=" + u.sortOnLoad[1] + "]").addClass("active")) : (n(u.sortSelector + "[data-sort=" + u.sortOnLoad + "]").addClass("active"), f = u.sortOnLoad, u.sortOnLoad = "desc"), i(f, e, o, u)), e = 0; 2 > e; e++) f = 0 == e ? f = u.prefix : "", u.transition[f + "transition"] = "all " + u.transitionSpeed + "ms ease-in-out", u.perspective[f + "perspective"] = u.perspectiveDistance + "px", u.perspective[f + "perspective-origin"] = u.perspectiveOrigin;
                    for (e = 0; 2 > e; e++) f = 0 == e ? f = u.prefix : "", u.clean[f + "transition"] = "none";
                    "list" == u.layoutMode ? (o.addClass(u.listClass), u.origDisplay = u.targetDisplayList) : (o.addClass(u.gridClass), u.origDisplay = u.targetDisplayGrid);
                    u.origLayout = u.layoutMode;
                    e = u.showOnLoad.split(" ");
                    n.each(e, function() {
                        n(u.filterSelector + '[data-filter="' + this + '"]').addClass("active")
                    });
                    o.find(u.targetSelector).addClass("mix_all");
                    "all" == e[0] && (e[0] = "mix_all", u.showOnLoad = "mix_all");
                    s = n();
                    n.each(e, function() {
                        s = s.add(n("." + this))
                    });
                    ...
                    setTimeout(function() {
                        ...
                        s.css("opacity", "1");
                        setTimeout(function() {
                            if ("list" == u.layoutMode ? s.removeStyle(u.prefix + "transition, transition").css({
                                    display: u.targetDisplayList,
                                    opacity: 1
                                }) : s.removeStyle(u.prefix + "transition, transition").css({
                                    display: u.targetDisplayGrid,
                                    opacity: 1
                                }), u.mixing = !1, "function" == typeof u.onMixLoad) {
                                var n = u.onMixLoad.call(this, u);
                                u = n ? n : u
                            }
                        }, u.transitionSpeed)
                    }, 10);
                    u.filter = u.showOnLoad;
                    n(u.sortSelector).bind(u.buttonEvent, function() {
                        if (!u.mixing) {
                            var i = n(this),
                                r = i.attr("data-sort"),
                                f = i.attr("data-order");
                            ...
                            } else n(u.sortSelector).removeClass("active"), i.addClass("active");
                            o.find(u.targetSelector).each(function() {
                                u.startOrder.push(n(this))
                            });
                            t(u.filter, r, f, o, u)
                        }
                    });
                    n(u.filterSelector).bind(u.buttonEvent, function() {
                        var i, r;
                        u.mixing || (i = n(this), !1 == u.multiFilter ? (n(u.filterSelector).removeClass("active"), i.addClass("active"), u.filter = i.attr("data-filter"), n(u.filterSelector + '[data-filter="' + u.filter + '"]').addClass("active")) : (r = i.attr("data-filter"), i.hasClass("active") ? (i.removeClass("active"), u.filter = u.filter.replace(RegExp("(\\s|^)" + r), "")) : (i.addClass("active"), u.filter = u.filter + " " + r)), t(u.filter, null, null, o, u))
                    })
                })
            },
            toGrid: function() {
                return this.each(function() {
                    var i = this.config;
                    "grid" != i.layoutMode && (i.layoutMode = "grid", t(i.filter, null, null, n(this), i))
                })
            },
            toList: function() {
                return this.each(function() {
                    var i = this.config;
                    "list" != i.layoutMode && (i.layoutMode = "list", t(i.filter, null, null, n(this), i))
                })
            },
            filter: function(i) {
                return this.each(function() {
                    var r = this.config;
                    r.mixing || (n(r.filterSelector).removeClass("active"), n(r.filterSelector + '[data-filter="' + i + '"]').addClass("active"), t(i, null, null, n(this), r))
                })
            },
            sort: function(i) {
                return this.each(function() {
                    var r = this.config,
                        e = n(this),
                        u, f;
                    r.mixing || (n(r.sortSelector).removeClass("active"), n.isArray(i) ? (u = i[0], f = i[1], n(r.sortSelector + '[data-sort="' + i[0] + '"][data-order="' + i[1] + '"]').addClass("active")) : (n(r.sortSelector + '[data-sort="' + i + '"]').addClass("active"), u = i, f = "desc"), e.find(r.targetSelector).each(function() {
                        r.startOrder.push(n(this))
                    }), t(r.filter, u, f, e, r))
                })
            },
            multimix: function(i) {
                return this.each(function() {
                    ...
                    n.extend(multiOut, i);
                    r.mixing || (n(r.filterSelector).add(r.sortSelector).removeClass("active"), n(r.filterSelector + '[data-filter="' + multiOut.filter + '"]').addClass("active"), "undefined" != typeof multiOut.sort && (n(r.sortSelector + '[data-sort="' + multiOut.sort + '"][data-order="' + multiOut.order + '"]').addClass("active"), u.find(r.targetSelector).each(function() {
                        r.startOrder.push(n(this))
                    })), r.layoutMode = multiOut.layoutMode, t(multiOut.filter, multiOut.sort, multiOut.order, u, r))
                })
            },
            remix: function(i) {
                return this.each(function() {
                    var r = this.config,
                        u = n(this);
                    r.origOrder = [];
                    u.find(r.targetSelector).each(function() {
                        var t = n(this);
                        t.addClass("mix_all");
                        r.origOrder.push(t)
                    });
                    r.mixing || "undefined" == typeof i || (n(r.filterSelector).removeClass("active"), n(r.filterSelector + '[data-filter="' + i + '"]').addClass("active"), t(i, null, null, u, r))
                })
            }
        };
        n.fn.mixitup = function(n) {
            return r[n] ? r[n].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" == typeof n || !n ? r.init.apply(this, arguments) : void 0
        };
        n.fn.removeStyle = function(t) {
            return this.each(function() {
                var r = n(this),
                    i;
                t = t.replace(/\s+/g, "");
                i = t.split(",");
                n.each(i, function() {
                    var n = RegExp(this.toString() + "[^;]+;?", "g");
                    r.attr("style", function(t, i) {
                        if (i) return i.replace(n, "")
                    })
                })
            })
        }
    ...
    function(n) {
        n.flexslider = function(t, i) {
            ...
            r.setProps = function(n, t, i) {
                ...
                r.transitions && (u = h ? "translate3d(0," + u + ",0)" : "translate3d(" + u + ",0,0)", i = i !== undefined ? i / 1e3 + "s" : "0s", r.container.css("-" + r.pfx + "-transition-duration", i));
                r.args[r.prop] = u;
            ...
            r.setup = function(t) {
                if (c) r.slides.css({
                    ...
                    r.vars.animationLoop && !e && (r.cloneCount = 2, r.cloneOffset = 1, t !== "init" && r.container.find(".clone").remove(), r.container.append(r.slides.first().clone().addClass("clone").attr("aria-hidden", "true")).prepend(r.slides.last().clone().addClass("clone").attr("aria-hidden", "true")));
            ...
            r.doMath = function() {
                ...
                e ? (r.itemT = r.vars.itemWidth + n, r.minW = t ? t * r.itemT : r.w, r.maxW = i ? i * r.itemT - n : r.w, r.itemW = r.minW > r.w ? (r.w - n * (t - 1)) / t : r.maxW < r.w ? (r.w - n * (i - 1)) / i : r.vars.itemWidth > r.w ? r.w : r.vars.itemWidth, r.visible = Math.floor(r.w / r.itemW), r.move = r.vars.move > 0 && r.vars.move < r.visible ? r.vars.move : r.visible, r.pagingCount = Math.ceil((r.count - r.visible) / r.move + 1), r.last = r.pagingCount - 1, r.limit = r.pagingCount === 1 ? 0 : r.vars.itemWidth > r.w ? r.itemW * (r.count - 1) + n * (r.count - 1) : (r.itemW + n) * r.count - r.w - n) : (r.itemW = r.w, r.pagingCount = r.count, r.last = r.count - 1);
    ...
    function(n) {
        function i(i, r, u) {
            function s() {
                f.afterLoaded();
                f.settings.hideFramesUntilPreloaded && f.settings.preloader !== undefined && f.settings.preloader !== !1 && f.frames.show();
                f.settings.preloader !== undefined && f.settings.preloader !== !1 ? f.settings.hidePreloaderUsingCSS && f.transitionsSupported ? (f.prependPreloadingCompleteTo = f.settings.prependPreloadingComplete === !0 ? f.settings.preloader : n(f.settings.prependPreloadingComplete), f.prependPreloadingCompleteTo.addClass("preloading-complete"), setTimeout(l, f.settings.hidePreloaderDelay)) : f.settings.preloader.fadeOut(f.settings.hidePreloaderDelay, function() {
            ...
            function a(t, i) {
                var e = [],
                    r, u;
                if (i)
                    for (u = t; u > 0; u--) e.push(n("body").find('img[src="' + f.settings.preloadTheseImages[u - 1] + '"]'));
                else
                    for (r = t; r > 0; r--) f.frames.eq(f.settings.preloadTheseFrames[r - 1] - 1).find("img").each(function() {
                        e.push(n(this)[0])
                    });
                return e
            }
            ...
            function v(t, i) {
                function l() {
                    var t = n(s),
                        o = n(f);
                    u && (f.length ? u.reject(r, t, o) : u.resolve(r));
                    n.isFunction(i) && i.call(e, r, t, o)
                }

                function h(t, i) {
                    t.src !== c && n.inArray(t, o) === -1 && (o.push(t), i ? f.push(t) : s.push(t), n.data(t, "imagesLoaded", {
                        isBroken: i,
                        src: t.src
                    }), a && u.notifyWith(n(t), [i, r, n(s), n(f)]), r.length === o.length && (setTimeout(l), r.unbind(".imagesLoaded")))
                }
                var c = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==",
                    e = t,
                    u = n.isFunction(n.Deferred) ? n.Deferred() : 0,
                    a = n.isFunction(u.notify),
                    r = e.find("img").add(e.filter("img")),
                    o = [],
                    s = [],
                    f = [];
                n.isPlainObject(i) && n.each(i, function(n, t) {
                    n === "callback" ? i = t : u && u[n](t)
                });
                r.length ? r.bind("load.imagesLoaded error.imagesLoaded", function(n) {
                    ...
                    if (i.complete && i.naturalWidth !== undefined) {
                        h(i, i.naturalWidth === 0 || i.naturalHeight === 0);
                        return
                    }(i.readyState || i.complete) && (i.src = c, i.src = u)
                }) : l()
            }
            ...
            function l() {
                function r(n, t) {
                    var r;
                    for (var i in t) r = i === "left" || i === "right" ? u[i] : i, n === parseFloat(r) && f._initCustomKeyEvent(t[i])
                }

                function e() {
                    f.canvas.on("touchmove.sequence", o);
                    i = null;
                    t = !1
                }

                function o(n) {
                    if (f.settings.swipePreventsDefault && n.preventDefault(), t) {
                        var o = n.originalEvent.touches[0].pageX,
                            h = n.originalEvent.touches[0].pageY,
                            r = i - o,
                            u = s - h;
                        Math.abs(r) >= f.settings.swipeThreshold ? (e(), r > 0 ? f._initCustomKeyEvent(f.settings.swipeEvents.left) : f._initCustomKeyEvent(f.settings.swipeEvents.right)) : Math.abs(u) >= f.settings.swipeThreshold && (e(), u > 0 ? f._initCustomKeyEvent(f.settings.swipeEvents.down) : f._initCustomKeyEvent(f.settings.swipeEvents.up))
                    }
                }
                ...
                function h(n) {
                    if (n.originalEvent.touches.length === 1) {
                        ...
                        s = n.originalEvent.touches[0].pageY;
                        t = !0;
                        f.canvas.on("touchmove.sequence", o)
                    }
                }
                var u, i, s, t;
                if (n(f.settings.preloader).remove(), f.nextButton = f._renderUiElements(f.settings.nextButton, ".sequence-next"), f.prevButton = f._renderUiElements(f.settings.prevButton, ".sequence-prev"), f.pauseButton = f._renderUiElements(f.settings.pauseButton, ".sequence-pause"), f.pagination = f._renderUiElements(f.settings.pagination, ".sequence-pagination"), f.nextButton !== undefined && f.nextButton !== !1 && f.settings.showNextButtonOnInit === !0 && f.nextButton.show(), f.prevButton !== undefined && f.prevButton !== !1 && f.settings.showPrevButtonOnInit === !0 && f.prevButton.show(), f.pauseButton !== undefined && f.pauseButton !== !1 && f.settings.showPauseButtonOnInit === !0 && f.pauseButton.show(), f.settings.pauseIcon !== !1 ? (f.pauseIcon = f._renderUiElements(f.settings.pauseIcon, ".sequence-pause-icon"), f.pauseIcon !== undefined && f.pauseIcon.hide()) : f.pauseIcon = undefined, f.pagination !== undefined && f.pagination !== !1) {
                    f.paginationLinks = f.pagination.children();
                    f.paginationLinks.on("click.sequence", function() {
                        var t = n(this).index() + 1;
                        f.goTo(t)
                    });
                    f.settings.showPaginationOnInit === !0 && f.pagination.show()
                }
                f.nextFrameID = f.settings.startingFrameID;
                f.settings.hashTags === !0 && (f.frames.each(function() {
                    f.frameHashID.push(n(this).prop(f.getHashTagFrom))
                }), f.currentHashTag = location.hash.replace("#", ""), f.currentHashTag === undefined || f.currentHashTag === "" ? f.nextFrameID = f.settings.startingFrameID : (f.frameHashIndex = n.inArray(f.currentHashTag, f.frameHashID), f.nextFrameID = f.frameHashIndex !== -1 ? f.frameHashIndex + 1 : f.settings.startingFrameID));
                f.nextFrame = f.frames.eq(f.nextFrameID - 1);
                f.nextFrameChildren = f.nextFrame.children();
                f.pagination !== undefined && n(f.paginationLinks[f.settings.startingFrameID - 1]).addClass("current");
                f.transitionsSupported ? f.settings.animateStartingFrameIn ? f.settings.reverseAnimationsWhenNavigatingBackwards && f.settings.autoPlayDirection - 1 && f.settings.animateStartingFrameIn ? (f._resetElements(f.transitionPrefix, f.nextFrameChildren, "0s"), f.nextFrame.addClass("animate-out"), f.goTo(f.nextFrameID, -1, !0)) : f.goTo(f.nextFrameID, 1, !0) : (f.currentFrameID = f.nextFrameID, f.settings.moveActiveFrameToTop && f.nextFrame.css("z-index", f.numberOfFrames), f._resetElements(f.transitionPrefix, f.nextFrameChildren, "0s"), f.nextFrame.addClass("animate-in"), f.settings.hashTags && f.settings.hashChangesOnFirstFrame && (f.currentHashTag = f.nextFrame.prop(f.getHashTagFrom), document.location.hash = "#" + f.currentHashTag), setTimeout(function() {
                    f._resetElements(f.transitionPrefix, f.nextFrameChildren, "")
                }, 100), f._resetAutoPlay(!0, f.settings.autoPlayDelay)) : (f.container.addClass("sequence-fallback"), f.currentFrameID = f.nextFrameID, f.settings.hashTags && f.settings.hashChangesOnFirstFrame && (f.currentHashTag = f.nextFrame.prop(f.getHashTagFrom), document.location.hash = "#" + f.currentHashTag), f.frames.addClass("animate-in"), f.frames.not(":eq(" + (f.nextFrameID - 1) + ")").css({
                    display: "none",
                    opacity: 0
                }), f._resetAutoPlay(!0, f.settings.autoPlayDelay));
                f.nextButton !== undefined && f.nextButton.bind("click.sequence", function() {
                    f.next()
                });
                f.prevButton !== undefined && f.prevButton.bind("click.sequence", function() {
                    f.prev()
                });
                f.pauseButton !== undefined && f.pauseButton.bind("click.sequence", function() {
                    f.pause(!0)
                });
                f.settings.keyNavigation && (u = {
                    left: 37,
                    right: 39
                }, n(document).bind("keydown.sequence", function(n) {
                    var t = String.fromCharCode(n.keyCode);
                    t > 0 && t <= f.numberOfFrames && f.settings.numericKeysGoToFrames && (f.nextFrameID = t, f.goTo(f.nextFrameID));
                    r(n.keyCode, f.settings.keyEvents);
                    r(n.keyCode, f.settings.customKeyEvents)
                }));
                f.canvas.on({
                    "mouseenter.sequence": function() {
                        f.settings.pauseOnHover && f.settings.autoPlay && !f.hasTouch && (f.isBeingHoveredOver = !0, f.isHardPaused || f.pause())
                    },
                    "mouseleave.sequence": function() {
                        f.settings.pauseOnHover && f.settings.autoPlay && !f.hasTouch && (f.isBeingHoveredOver = !1, f.isHardPaused || f.unpause())
                    }
                });
                if (f.settings.hashTags && n(window).bind("hashchange.sequence", function() {
                        var t = location.hash.replace("#", "");
                        f.currentHashTag !== t && (f.currentHashTag = t, f.frameHashIndex = n.inArray(f.currentHashTag, f.frameHashID), f.frameHashIndex !== -1 && (f.nextFrameID = f.frameHashIndex + 1, f.goTo(f.nextFrameID)))
                    }), f.settings.swipeNavigation && f.hasTouch) {
                    t = !1;
                    f.canvas.on("touchstart.sequence", h)
                }
            }
            var f = this,
                e, o, h, c;
            if (f.container = n(i), f.canvas = f.container.children(".sequence-canvas"), f.frames = f.canvas.children("li"), f._modernizrForSequence(), e = {
        ...
        i.prototype = {
            startAutoPlay: function(n) {
                var t = this;
                n = n === undefined ? t.settings.autoPlayDelay : n;
                t.unpause();
                t._resetAutoPlay();
            ...
            goTo: function(t, i, r) {
                ...
                if (u.settings.navigationSkip && u.active && (u.navigationSkipThresholdActive = !0, u.settings.fadeFrameWhenSkipped && u.nextFrame.stop().animate({
                    ...
                    if (u.active = !0, u._resetAutoPlay(), u.direction = i === undefined ? u.nextFrameID > u.currentFrameID ? 1 : -1 : i, u.currentFrame = u.canvas.children(".animate-in"), u.nextFrame = u.frames.eq(u.nextFrameID - 1), u.currentFrameChildren = u.currentFrame.children(), u.nextFrameChildren = u.nextFrame.children(), u.pagination !== undefined && (u.paginationLinks.removeClass("current"), n(u.paginationLinks[u.nextFrameID - 1]).addClass("current")), u.transitionsSupported) u.currentFrame.length !== undefined ? (u.beforeCurrentFrameAnimatesOut(), u.settings.moveActiveFrameToTop && u.currentFrame.css("z-index", 1), u._resetElements(u.transitionPrefix, u.nextFrameChildren, "0s"), u.settings.reverseAnimationsWhenNavigatingBackwards && u.direction !== 1 ? u.settings.reverseAnimationsWhenNavigatingBackwards && u.direction === -1 && (u.nextFrame.addClass("animate-out"), u._reverseTransitionProperties()) : (u.nextFrame.removeClass("animate-out"), u._resetElements(u.transitionPrefix, u.currentFrameChildren, ""))) : u.isStartingFrame = !1, u.active = !0, u.currentFrame.unbind(u.transitionEnd), u.nextFrame.unbind(u.transitionEnd), u.settings.fadeFrameWhenSkipped && u.settings.navigationSkip && u.nextFrame.css("opacity", 1), u.beforeNextFrameAnimatesIn(), u.settings.moveActiveFrameToTop && u.nextFrame.css("z-index", u.numberOfFrames), u.settings.reverseAnimationsWhenNavigatingBackwards && u.direction !== 1 ? u.settings.reverseAnimationsWhenNavigatingBackwards && u.direction === -1 && (setTimeout(function() {
                        ...
                        u.settings.transitionThreshold === !1 || u.settings.transitionThreshold === 0 || r === !0 ? (u.currentFrame.toggleClass("animate-out animate-in"), u.nextFrame.addClass("animate-in")) : (u.currentFrame.toggleClass("animate-out animate-in"), u.settings.transitionThreshold !== !0 && (u.transitionThresholdTimer = setTimeout(function() {
                        ...
                        function h() {
                            u._setHashTag();
                            u.active = !1;
                            u._resetAutoPlay(!0, u.settings.autoPlayDelay)
                        }
                        switch (u.settings.fallback.theme) {
                            case "fade":
                                ...
                                u.currentFrame.animate({
                                    opacity: 0
                                }, u.settings.fallback.speed, function() {
                                    u.currentFrame.css({
                                        display: "none",
                                        "z-index": "1"
                                    });
                            ...
                            default:
                                var e = {},
                                    o = {},
                                    s = {};
                                u.direction === 1 ? (e.left = "-100%", o.left = "100%") : (e.left = "100%", o.left = "-100%");
                                s.left = "0";
                                s.opacity = 1;
                                u.currentFrame = u.frames.eq(u.currentFrameID - 1);
                                u.beforeCurrentFrameAnimatesOut();
                                u.currentFrame.animate(e, u.settings.fallback.speed, function() {
                                    u.currentFrame.css({
                                        display: "none",
                                        "z-index": "1"
                                    });
                                ...
                                u.beforeNextFrameAnimatesIn();
                                u.nextFrame.show().css(o);
                                u.nextFrame.css({
                                    display: "block",
                                    "z-index": u.numberOfFrames
                                }).animate(s, u.settings.fallback.speed, function() {
                                    h();
                                    u.afterNextFrameAnimatesIn()
                                })
                        }
                    }
                    u.currentFrameID = u.nextFrameID
                }
            },
            destroy: function(t) {
                var i = this;
                i.container.addClass("sequence-destroyed");
                i.nextButton !== undefined && i.nextButton.unbind("click.sequence");
                i.prevButton !== undefined && i.prevButton.unbind("click.sequence");
                i.pauseButton !== undefined && i.pauseButton.unbind("click.sequence");
                i.pagination !== undefined && i.paginationLinks.unbind("click.sequence");
                n(document).unbind("keydown.sequence");
                i.canvas.unbind("mouseenter.sequence, mouseleave.sequence, touchstart.sequence, touchmove.sequence");
                n(window).unbind("hashchange.sequence");
                i.stopAutoPlay();
                ...
                i.nextButton !== undefined && i.nextButton !== !1 && i.nextButton.hide();
                i.prevButton !== undefined && i.prevButton !== !1 && i.prevButton.hide();
                i.pauseButton !== undefined && i.pauseButton !== !1 && i.pauseButton.hide();
                i.pauseIcon !== undefined && i.pauseIcon !== !1 && i.pauseIcon.hide();
                i.pagination !== undefined && i.pagination !== !1 && i.pagination.hide();
                t !== undefined && t();
                i.destroyed();
                i.container.removeData()
            },
            _initCustomKeyEvent: function(n) {
                var t = this;
                switch (n) {
                    case "next":
                        t.next();
            ...
            _resetElements: function(n, t, i) {
                var r = this;
                t.css(r._prefixCSS(n, {
            ...
            _reverseTransitionProperties: function() {
                ...
                t.currentFrameChildren.each(function() {
                    u.push(parseFloat(n(this).css(t.transitionPrefix + "transition-duration").replace("s", "")) + parseFloat(n(this).css(t.transitionPrefix + "transition-delay").replace("s", "")))
                });
                t.nextFrameChildren.each(function() {
                    f.push(parseFloat(n(this).css(t.transitionPrefix + "transition-duration").replace("s", "")) + parseFloat(n(this).css(t.transitionPrefix + "transition-delay").replace("s", "")))
                });
                var e = Math.max.apply(Math, u),
                    o = Math.max.apply(Math, f),
                    i = e - o,
                    s = 0,
                    h = 0;
                i < 0 && !t.settings.preventDelayWhenReversingAnimations ? s = Math.abs(i) : i > 0 && (h = Math.abs(i));
                r = function(i, r, u, f) {
                    function e(n) {
                        n = n.split(",")[0];
                        return n.indexOf("cubic-bezier") < 0 && (n = {
                    ...
                    r.each(function() {
                        var s = parseFloat(n(this).css(t.transitionPrefix + "transition-duration").replace("s", "")),
                            ...
                            r, h, c;
                        o.indexOf("cubic") === -1 && (o = e(o));
                        t.settings.reverseEaseWhenNavigatingBackwards && (r = o.replace("cubic-bezier(", "").replace(")", "").split(","), n.each(r, function(n, t) {
                            r[n] = parseFloat(t)
                        }), h = [1 - r[2], 1 - r[3], 1 - r[0], 1 - r[1]], o = "cubic-bezier(" + h + ")");
                        c = s + l;
                        i["transition-duration"] = s + "s";
                        i["transition-delay"] = u - c + f + "s";
                        i["transition-timing-function"] = o;
                        n(this).css(t._prefixCSS(t.transitionPrefix, i))
                    })
                };
                r(t.transitionProperties, t.currentFrameChildren, e, s);
                r(t.transitionProperties, t.nextFrameChildren, o, h)
            },
            _prefixCSS: function(n, t) {
                var u = this,
                    i = {};
                for (var r in t) i[n + r] = t[r];
                return i
            },
            _resetAutoPlay: function(n, t) {
                var i = this;
                n === !0 ? i.settings.autoPlay && !i.isSoftPaused && (clearTimeout(i.autoPlayTimer), i.autoPlayTimer = setTimeout(function() {
                    i.settings.autoPlayDirection === 1 ? i.next() : i.prev()
                }, t)) : clearTimeout(i.autoPlayTimer)
            },
            _renderUiElements: function(t, i) {
                ...
                switch (t) {
                    case !1:
                        return undefined;
                    case !0:
                        return i === ".sequence-preloader" && r._defaultPreloader(r.container, r.transitionsSupported, r.animationPrefix), n(i, r.container);
                    default:
                        return n(t, r.container)
                }
            },
            _waitForAnimationsToComplete: function(t, i, r, u, f) {
                var e = this,
                    o;
                r === "out" ? o = function() {
                    e.afterCurrentFrameAnimatesOut();
                    e.settings.transitionThreshold === !0 && (f === 1 ? e.nextFrame.addClass("animate-in") : f === -1 && e.nextFrame.toggleClass("animate-out animate-in"))
                } : r === "in" && (o = function() {
                    e.afterNextFrameAnimatesIn();
                    e._setHashTag();
                    e.active = !1;
                    e.isHardPaused || e.isBeingHoveredOver || (e.delayUnpause ? (e.delayUnpause = !1, e.unpause()) : e.unpause(!1))
                });
                i.data("animationEnded", !1);
                t.bind(e.transitionEnd, function(r) {
                    n(r.target).data("animationEnded", !0);
                    var u = !0;
                    i.each(function() {
                        if (n(this).data("animationEnded") === !1) return u = !1, !1
                    });
                    u && (t.unbind(e.transitionEnd), o())
                })
            },
            _setHashTag: function() {
                var t = this;
                t.settings.hashTags && (t.currentHashTag = t.nextFrame.prop(t.getHashTagFrom), t.frameHashIndex = n.inArray(t.currentHashTag, t.frameHashID), t.frameHashIndex === -1 || !t.settings.hashChangesOnFirstFrame && t.isStartingFrame && t.transitionsSupported ? (t.nextFrameID = t.settings.startingFrameID, t.isStartingFrame = !1) : (t.nextFrameID = t.frameHashIndex + 1, document.location.hash = "#" + t.currentHashTag))
            },
            _modernizrForSequence: function() {
                window.ModernizrForSequence = function(n, t, i) {
                    function a(n) {
                        p.cssText = n
                    }
                    ...
                    function v(n, t) {
                        var u, r;
                        for (u in n)
                            if (r = n[u], !g(r, "-") && p[r] !== i) return t == "pfx" ? r : !0;
                        return !1
                    }
                    ...
                    function s(n, t, i) {
                        var r = n.charAt(0).toUpperCase() + n.slice(1),
                            f = (n + " " + b.join(r + " ") + r).split(" ");
                        return u(t, "string") || u(t, "undefined") ? v(f, t) : (f = (n + " " + k.join(r + " ") + r).split(" "), nt(f, t, i))
                    }
                    var r = {},
                        tt = t.documentElement,
                        y = t.createElement("modernizrForSequence"),
                        p = y.style,
                        it, ft = {}.toString,
                        w = "Webkit Moz O ms",
                        b = w.split(" "),
                        ...
                        e, c = {}.hasOwnProperty,
                        l, o;
                    l = !u(c, "undefined") && !u(c.call, "undefined") ? function(n, t) {
                        return c.call(n, t)
                    } : function(n, t) {
                    ...
                    Function.prototype.bind || (Function.prototype.bind = function(n) {
                        ...
                        return i = h.call(arguments, 1), r = function() {
                            var f, e, u;
                            return self instanceof r ? (f = function() {}, f.prototype = t.prototype, e = new f, u = t.apply(e, i.concat(h.call(arguments))), Object(u) === u ? u : e) : t.apply(n, i.concat(h.call(arguments)))
                        }, r
                    });
                    f.svg = function() {
                        return !!t.createElementNS && !!t.createElementNS(rt.svg, "svg").createSVGRect
                    };
                    for (o in f) l(f, o) && (e = o.toLowerCase(), r[e] = f[o](), d.push((r[e] ? "" : "no-") + e));
                    return r.addTest = function(n, t) {
                        if (typeof n == "object")
                            ...
                            enableClasses && (tt.className += " " + (t ? "" : "no-") + n);
                            r[n] = t
                        }
                        return r
                    }, a(""), y = it = null, r._version = "2.6.1", r._domPrefixes = k, r._cssomPrefixes = b, r.testProp = function(n) {
                        return v([n])
                    }, r.testAllProps = s, r.prefixed = function(n, t, i) {
                        return t ? s(n, t, i) : s(n, "pfx")
                    }, r
                }(self, self.document)
            },
            _defaultPreloader: function(t, i, r) {
                n("head").append("<style>.sequence-preloader{height: 100%;position: absolute;width: 100%;z-index: 999999;}@" + r + "keyframes preload{0%{opacity: 1;}50%{opacity: 0;}100%{opacity: 1;}}.sequence-preloader .preloading .circle{fill: #ff9442;display: inline-block;height: 12px;position: relative;top: -50%;width: 12px;" + r + "animation: preload 1s infinite; animation: preload 1s infinite;}.preloading{display:block;height: 12px;margin: 0 auto;top: 50%;margin-top:-6px;position: relative;width: 48px;}.sequence-preloader .preloading .circle:nth-child(2){" + r + "animation-delay: .15s; animation-delay: .15s;}.sequence-preloader .preloading .circle:nth-child(3){" + r + "animation-delay: .3s; animation-delay: .3s;}.preloading-complete{opacity: 0;visibility: hidden;" + r + "transition-duration: 1s; transition-duration: 1s;}div.inline{background-color: #348BBF; margin-right: 4px; float: left;}<\/style>");
                t.prepend('<div class="sequence-preloader"><svg class="preloading" xmlns="http://www.w3.org/2000/svg"><circle class="circle" cx="6" cy="6" r="6" /><circle class="circle" cx="22" cy="6" r="6" /><circle class="circle" cx="38" cy="6" r="6" /><\/svg><\/div>');
                ModernizrForSequence.svg || i ? i || setInterval(function() {
                    n(".sequence-preloader").fadeToggle(500)
                }, 500) : (n(".sequence-preloader").prepend('<div class="preloading"><div class="circle inline"><\/div><div class="circle inline"><\/div><div class="circle inline"><\/div><\/div>'), setInterval(function() {
                    n(".sequence-preloader .circle").fadeToggle(500)
                }, 500))
            },
            _operaTest: function() {
                n("body").append('<span id="sequence-opera-test"><\/span>');
                var t = n("#sequence-opera-test");
                return t.css("-o-transition", "1s"), t.css("-o-transition") !== "1s" ? (t.remove(), !1) : (t.remove(), !0)
            }
        };
        r = {
            startingFrameID: 1,
        ...
        n.fn.sequence = function(t) {
            return this.each(function() {
                n.data(this, "sequence") || n.data(this, "sequence", new i(n(this), t, r))
            })
        }
    }(jQuery);
window.matchMedia = window.matchMedia || function(n) {
    ...
    function(n) {
        ...
        var r = {};
        if (n.respond = r, r.update = function() {}, r.mediaQueriesSupported = n.matchMedia && n.matchMedia("only all").matches, !r.mediaQueriesSupported) {
            var t = n.document,
                u = t.documentElement,
                f = [],
                e = [],
                ...
                h = {},
                y = 30,
                o = t.getElementsByTagName("head")[0] || u,
                ...
                p = function() {
                    for (var r = 0; r < s.length; r++) {
                        var t = s[r],
                            i = t.href,
                            u = t.media,
                            f = t.rel && t.rel.toLowerCase() === "stylesheet";
                        !i || !f || h[i] || (t.styleSheet && t.styleSheet.rawCssText ? (b(t.styleSheet.rawCssText, i, u), h[i] = !0) : (/^([a-zA-Z:]*\/\/)/.test(i) || nt) && i.replace(RegExp.$1, "").split("/")[0] !== n.location.host || c.push({
                            href: i,
                            media: u
                        }))
                    }
                ...
                b = function(n, t, i) {
                    var s = n.match(/@media[^\{]+\{([^\{\}]*\{[^\}\{]*\})+/gi),
                        h = s && s.length || 0,
                        c, l, u, a, r, y, p, o;
                    for (t = t.substring(0, t.lastIndexOf("/")), c = function(n) {
                            return n.replace(/(url\()['"]?([^\/\)'"][^:\)'"]+)['"]?(\))/g, "$1" + t + "$2$3")
                        }, l = !h && i, t.length && (t += "/"), l && (h = 1), u = 0; u < h; u++)
                        for (l ? (a = i, e.push(c(n))) : (a = s[u].match(/@media *([^\{]+)\{([\S\s]+?)$/) && RegExp.$1, e.push(RegExp.$2 && c(RegExp.$2))), y = a.split(","), p = y.length, o = 0; o < p; o++) r = y[o], f.push({
                            media: r.split("(")[0].match(/(only\s+)?([a-zA-Z]+)\s?/) && RegExp.$2 || "all",
                            rules: e.length - 1,
                            hasquery: r.indexOf("(") > -1,
                            minw: r.match(/\(\s*min\-width\s*:\s*(\s*[0-9\.]+)(px|em)\s*\)/) && parseFloat(RegExp.$1) + (RegExp.$2 || ""),
                            maxw: r.match(/\(\s*max\-width\s*:\s*(\s*[0-9\.]+)(px|em)\s*\)/) && parseFloat(RegExp.$1) + (RegExp.$2 || "")
                        });
                    v()
                },
                l, k, d = function() {
                    var r, i = t.createElement("div"),
                        n = t.body,
                        f = !1;
                    return i.style.cssText = "position:absolute;font-size:1em;width:1em", n || (n = f = t.createElement("body"), n.style.background = "none"), n.appendChild(i), u.insertBefore(n, u.firstChild), r = i.offsetWidth, f ? u.removeChild(n) : n.removeChild(i), a = parseFloat(r)
                },
                a, v = function(r) {
                    var rt = "clientWidth",
                        ut = u[rt],
                        ft = t.compatMode === "CSS1Compat" && ut || t.body[rt] || ut,
                        p = {},
                        ct = s[s.length - 1],
                        et = (new Date).getTime(),
                        tt, g, nt, h, it;
                    ...
                    for (tt in f)
                        if (f.hasOwnProperty(tt)) {
                            var c = f[tt],
                                ...
                                st = b === null,
                                ht = "em";
                            !w || (w = parseFloat(w) * (w.indexOf(ht) > -1 ? a || d() : 1));
                            !b || (b = parseFloat(b) * (b.indexOf(ht) > -1 ? a || d() : 1));
                            c.hasquery && (ot && st || !(ot || ft >= w) || !(st || ft <= b)) || (p[c.media] || (p[c.media] = []), p[c.media].push(e[c.rules]))
                        }
                    for (g in i) i.hasOwnProperty(g) && i[g] && i[g].parentNode === o && o.removeChild(i[g]);
                    for (nt in p) p.hasOwnProperty(nt) && (h = t.createElement("style"), it = p[nt].join("\n"), h.type = "text/css", h.media = nt, o.insertBefore(h, ct.nextSibling), h.styleSheet ? h.styleSheet.cssText = it : h.appendChild(t.createTextNode(it)), i.push(h))
                },
                tt = function(n, t) {
                    var i = it();
            ...
            p();
            r.update = p;
            n.addEventListener ? n.addEventListener("resize", g, !1) : n.attachEvent && n.attachEvent("onresize", g)
        }
    }(this);
$(function() {
    var i, n;
    !Modernizr.touch && Modernizr.cssanimations && ($("[data-animation-delay]").each(function() {
    ...
    }), $("[data-animation]").waypoint(function(n) {
        n == "down" && $(this).addClass("animated " + $(this).data("animation"))
    }, {
        offset: "90%"
    }).waypoint(function(n) {
        n == "up" && $(this).removeClass("animated " + $(this).data("animation"))
    }, {
        offset: $(window).height() + 1
    }));
    $("body>section[id]").waypoint(function() {
        var n = $('.site-navigation a[href="#' + this.id + '"]').parent("li");
    ...
    $(".site-navigation a[href^='#'],.next-screen").click(function(n) {
        var t = $($(this).attr("href"));
        t.length && (n.preventDefault(), $("body,html").animate({
    ...
    i.waypoint(function(t) {
        t == "down" && n.addClass("nav-visible")
    }).waypoint(function(t) {
        t == "up" && n.removeClass("nav-visible")
    });
    ...
    $(".portfolio-filtering a").on("click", function(n) {
        n.preventDefault()
    });
    $("a[href='#map-toggle']").click(function(n) {
        n.preventDefault();
        $(".map-holder").toggleClass("map-visible")
    });
    var u = $(".flexslider").flexslider({
            animation: "slide",
            direction: "vertical",
            controlNav: !1,
            directionNav: !1,
        ...
        r = $(".home-screen-slider").sequence(t).data("sequence");
    r.beforeNextFrameAnimatesIn = function() {
        u.flexAnimate(r.nextFrameID - 1)
    };
    $(t.nextButton + "," + t.prevButton).click(function(n) {
        n.preventDefault()
    })
});
$(window).load(function() {
        if ($("#gmap").length) var n = new google.maps.LatLng(-33.82629, 151.05678),
            t = {
                zoom: 15,
                center: n,
                mapTypeId: google.maps.MapTypeId.ROADMAP
            },
            i = new google.maps.Map(document.getElementById("gmap"), t),
...
$(document).ready(function() {
    for (var t = [{
        ...
        }], i = "", n = 0; n < t.length; n++) i += '<a href="#" data-theme-css="' + t[n].style + '" title="' + t[n].title + '" style="display: inline-block;width: 30px;margin-right: 10px;text-decoration: none!important;height: 30px;background-color: ' + t[n].color + '"><\/a>';
